...
class Input(Layer):
    def __init__(self,input_shape=None,batch_size=None,
        ...
        if input_shape and batch_input_shape:
            raise ValueError("Only provide the input_shape or batch_input_shape argument to Input, not both at the same time.")
        if input_tensor is not None and batch_input_shape is None:
            ...
            try:
                ...
                if not input_shape and not batch_input_shape:
                    raise ValueError('Input was provided an input_tensor argument, but its input shape cannot be automatically inferred. You should pass an input_shape or batch_input_shape argument.')
