...
class FullyConnected(Layer):
    ...
    def forward(self,inputs,*args,**kwargs):
        ...
        self.output_shape[0]=self.input_shape[0]#the number of batch size
        self.inputs=inputs
...
class Softmax(FullyConnected):
    def __init__(self,output_dim,input_dim=None,initializer=gaussian_initializer):
...
class Activation(Layer):
    ...
    def __init__(self,activaor,input_shape=None):
        super().__init__()
        self.activator=activations.get(activaor)
