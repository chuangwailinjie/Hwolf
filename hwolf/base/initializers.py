...
# recommend ues in linear activator
...
def constant_initializer(shape,value=0.0):
...
def get(initializer):
    if isinstance(initializer, str):
        ...
        elif initializer in ('gaussian','gaussian_initializer'):
            return gaussian_initializer
        elif initializer in ('msra','msra_initializer'):
            return msra_initializer
        elif initializer in ('zero','zeros'):
            return zeros
        elif initializer in ('constant', 'constant_initializer'):
